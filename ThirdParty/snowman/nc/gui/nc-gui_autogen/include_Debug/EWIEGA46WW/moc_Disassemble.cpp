...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_nc__gui__Disassemble_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_nc__gui__Disassemble_t qt_meta_stringdata_nc__gui__Disassemble = {
    {
QT_MOC_LITERAL(0, 0, 20) // "nc::gui::Disassemble"
...
QT_INIT_METAOBJECT const QMetaObject nc::gui::Disassemble::staticMetaObject = { {
    QMetaObject::SuperData::link<Command::staticMetaObject>(),
    qt_meta_stringdata_nc__gui__Disassemble.data,
    qt_meta_data_nc__gui__Disassemble,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *nc::gui::Disassemble::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_nc__gui__Disassemble.stringdata0))
