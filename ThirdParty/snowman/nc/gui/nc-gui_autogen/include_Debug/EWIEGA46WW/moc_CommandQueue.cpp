...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_nc__gui__CommandQueue_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_nc__gui__CommandQueue_t qt_meta_stringdata_nc__gui__CommandQueue = {
    {
QT_MOC_LITERAL(0, 0, 21), // "nc::gui::CommandQueue"
QT_MOC_LITERAL(1, 22, 11), // "nextCommand"
QT_MOC_LITERAL(2, 34, 0), // ""
QT_MOC_LITERAL(3, 35, 4), // "idle"
QT_MOC_LITERAL(4, 40, 6), // "cancel"
QT_MOC_LITERAL(5, 47, 5), // "clear"
QT_MOC_LITERAL(6, 53, 15) // "commandFinished"

    },
    "nc::gui::CommandQueue\0nextCommand\0\0"
    "idle\0cancel\0clear\0commandFinished"
};
...
void nc::gui::CommandQueue::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (CommandQueue::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CommandQueue::nextCommand)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (CommandQueue::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CommandQueue::idle)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject nc::gui::CommandQueue::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_nc__gui__CommandQueue.data,
    qt_meta_data_nc__gui__CommandQueue,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *nc::gui::CommandQueue::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_nc__gui__CommandQueue.stringdata0))
