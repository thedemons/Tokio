...
void ImGui_ImplWin32_EnableAlphaCompositing(void* hwnd)
{
    ...
    if (hUser)
    {
        ...
        pfnSetWindowCompositionAttribute DwmSetWindowCompositionAttribute = (pfnSetWindowCompositionAttribute)GetProcAddress(hUser, "SetWindowCompositionAttribute");
        if (DwmSetWindowCompositionAttribute)
        {
            enum ACCENT_STATE
            {
                ACCENT_DISABLED = 0,
            ...
            policy.GradientColor = (0x40 << 24) | (0x000000 & 0xFFFFFF);
            ...
            data.pvData = &policy;
            DwmSetWindowCompositionAttribute((HWND)hwnd, &data);
            ...
            //    DwmSetWindowCompositionAttribute((HWND)hwnd, &CompositionAttribute);
            //}
